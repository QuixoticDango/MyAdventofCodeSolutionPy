...
# Most recent guess on bottom:
# 324664703377816
# 330173788399976 <- haven't tried but it's probably wrong
# 380504538687554 <- original sort
# 357460477079061 <- still not correct
# 357907198933892 <- Someone else's code but I finally got it on my own.